...
sap.ui.define([
  ...
  DateType, DateTimeType, FloatType,
  Column, ColumnListItem, Text, Link, ObjectNumber, ObjectStatus, CheckBox, MessageToast, DateFormat
) {
  "use strict";

  return Controller.extend("openui5-odatav4-test-app.controller.List", {
    ...
    _loadFieldMetadata: function(sEntity) {
      return new Promise(function(resolve, reject) {
        ...
        oModel.bindList(sPath, null, [new Sorter("seq_no_grid")], aFilters)
     ...
     * @private
     */
    _getColumnWidth: function(oField) {
     ...
     * @private
     */
    _getMinScreenWidth: function(oField) {
    ...
    onItemSelect: function(oEvent) {
      ...
      if (oItem) {
        this.onItemPress({ getSource: function() { return oItem; } });
      }
    },
