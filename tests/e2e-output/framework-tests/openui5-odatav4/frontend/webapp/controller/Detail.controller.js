...
sap.ui.define([
  ...
  DateType, DateTimeType, FloatType, DateFormat,
  Label, Text, Input, TextArea, CheckBox, DatePicker, DateTimePicker, Select, Item,
  MessageBox, MessageToast
) {
  "use strict";

  return Controller.extend("openui5-odatav4-test-app.controller.Detail", {
          ...
          Object.keys(oEntityType).forEach(function(sKey) {
            if (!sKey.startsWith("$") && !sKey.startsWith("@")) {
              ...
              if (oProperty && typeof oProperty === "object" && oProperty.$Type) {
                ...
                var bIsSystem = ["created_at", "updated_at", "created_by", "updated_by", "version", "is_deleted"].includes(sKey);
     ...
     * @private
     */
    _createReferenceSelect: function(oField) {
