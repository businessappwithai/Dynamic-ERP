...
sap.ui.define([
  ...
  Label, Input, TextArea, CheckBox, DatePicker, DateTimePicker, Select, Item,
  MessageBox, MessageToast
) {
  "use strict";

  return Controller.extend("openui5-odatav4-test-app.controller.Create", {
    ...
    _onRouteMatched: function(oEvent) {
      ...
      // Load field metadata
      this._loadFieldMetadata(sEntity).then(function(aFields) {
    ...
    _loadFieldMetadata: function(sEntity) {
      return new Promise(function(resolve, reject) {
        ...
        oModel.bindList(sPath, null, [new Sorter("seq_no")], aFilters)
     ...
     * @private
     */
    _isSystemField: function(sColumnName) {
      var aSystemFields = ["id", "created_at", "updated_at", "created_by", "updated_by", "version", "is_deleted"];
     ...
     * @private
     */
    _mapODataType: function(sODataType) {
      var mTypeMap = {
        "Edm.String": "string",
        "Edm.Int32": "integer",
        "Edm.Int64": "bigint",
     ...
     * @private
     */
    _createReferenceSelect: function(oField, sPath) {
    ...
    _initializeFormData: function(aFields) {
      ...
      aFields.forEach(function(oField) {
        ...
        switch (sDataType) {
          case "boolean":
            oFormData[sColumnName] = oField.default_value === "true" || oField.default_value === true;
            break;
          case "integer":
          case "bigint":
            oFormData[sColumnName] = oField.default_value ? parseInt(oField.default_value, 10) : null;
            break;
          case "decimal":
          case "double":
          case "money":
            oFormData[sColumnName] = oField.default_value ? parseFloat(oField.default_value) : null;
            break;
          default:
     ...
     * @private
     */
    _formatColumnName: function(sColumn) {
      return sColumn
        .replace(/_/g, " ")
        .replace(/\b\w/g, function(c) { return c.toUpperCase(); });
    },
     ...
     * @private
     */
    _cleanFormData: function(oFormData) {
      var oCleanData = {};
