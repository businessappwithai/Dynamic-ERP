...
sap.ui.define([
  ...
  "sap/m/MessageBox"
], function(UIComponent, Device, JSONModel, fioriLibrary, FlexibleColumnLayoutSemanticHelper, MessageBox) {
  "use strict";

  return UIComponent.extend("openui5-odatav4-test-app.Component", {
          ...
          if (oParams.response) {
            ...
            switch (nStatus) {
              ...
              case 404:
                ...
                break;
              case 409:
                sMessage = "Conflict: The resource has been modified. Please refresh and try again.";
                break;
              case 500:
