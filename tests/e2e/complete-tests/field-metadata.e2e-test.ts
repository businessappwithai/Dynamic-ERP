...
test.describe('Application Dictionary - Field Metadata', () => {
  ...
  test('GET /api/bus/users/fields/grid should return field metadata for grid display', async ({ request }) => {
  ...
  test('GET /api/bus/users/fields/form should return field metadata for form display', async ({ request }) => {
  ...
  test('GET /api/bus/posts/fields/grid should return field metadata for posts', async ({ request }) => {
  ...
  test('GET /api/bus/posts/fields/form should return field metadata for posts', async ({ request }) => {
