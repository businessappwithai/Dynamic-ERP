 ...
 *
 * Generated: 2026-05-16T05:39:24.963Z
 * Project: CRM Test Fixed
 */
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-xl text-muted-foreground font-light max-w-2xl leading-relaxed">
                Manage entities, field layouts, and application configuration for CRM Test Fixed
              </p>
            </div>
            <Button
              variant="outline"
      ...
      <footer className="border-t border-border mt-16">
        <div className="max-w-7xl mx-auto px-8 py-8">
          <p className="text-sm text-muted-foreground">
            CRM Test Fixed · Generated by ERDwithAI · Swiss Clean Design
          </p>
        </div>
      </footer>
    </div>
