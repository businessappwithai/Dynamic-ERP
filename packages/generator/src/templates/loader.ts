...
export class TemplateLoader {
  ...
  private registerHelpers(): void {
    ...
    // ========================================================================
    Handlebars.registerHelper('randomSeq', (index: number) =>
      (index + 1) * 10 + Math.floor(Math.random() * 5)
    );
    ...
    // ========================================================================
    Handlebars.registerHelper('nestControllerName', (entity: string) =>
      `${pascalCase(entity)}Controller`
    );
    Handlebars.registerHelper('nestServiceName', (entity: string) =>
      `${pascalCase(entity)}Service`
    );
    Handlebars.registerHelper('nestModuleName', (entity: string) =>
      `${pascalCase(entity)}Module`
    );
    Handlebars.registerHelper('nestDtoName', (entity: string, prefix: string = '') =>
      `${prefix}${pascalCase(entity)}Dto`
    );
    Handlebars.registerHelper('nestGuardName', (name: string) =>
      `${pascalCase(name)}Guard`
    );
    Handlebars.registerHelper('nestDecoratorName', (name: string) =>
      `${pascalCase(name)}`
    );
    ...
    Handlebars.registerHelper('isLast', (index: number, array: unknown[]) =>
    ...
    Handlebars.registerHelper('mockUniqueValue', (type: string, fieldName: string, index: number) => {
      const typeLower = type?.toLowerCase() || '';
      const nameLower = fieldName?.toLowerCase() || '';
