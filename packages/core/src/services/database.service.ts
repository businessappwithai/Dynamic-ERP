...
async function _runMigrationsImpl(db: Kysely<Database>): Promise<void> {
  ...
  try {
    await db.schema
      ...
      .addColumn("generated_code", "longtext")
      ...
      .addColumn("generated_hook_code", "longtext")
  ...
  try {
    await db.schema
      ...
      .addColumn("stdout_log", "longtext")
      .addColumn("stderr_log", "longtext")
