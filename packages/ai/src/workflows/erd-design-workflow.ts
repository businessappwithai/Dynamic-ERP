...
import type { WorkflowState, DomainAnalysis, EntityCandidate, RelationshipCandidate } from '../types';
...
} as unknown as StepParams<'analyze-domain', z.ZodObject<any>, typeof descriptionInputSchema, typeof domainAnalysisOutputSchema, z.ZodAny, z.ZodAny>);
...
export const generateMermaidStep = createStep({
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
} as unknown as StepParams<'generate-mermaid', z.ZodObject<any>, typeof entitiesInputSchema, typeof mermaidOutputSchema, z.ZodAny, z.ZodAny>);
...
export type { WorkflowState, DomainAnalysis, EntityCandidate, RelationshipCandidate };
