...
export default function DeployPage() {
  ...
  const { getProject, loadProject, updateProject, setCurrentStep, currentProject, isLoading } = useProjectStore();
  ...
  const [serverStatus, setServerStatus] = useState<"stopped" | "running" | "starting" | "stopping" | "error">("stopped");
  ...
  // Poll server status when deployment is complete
  useEffect(() => {
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          {(isDeploying || deploymentComplete || error) && (
            <div className="space-y-6">
                        ...
                        <div className={`flex items-center gap-2 px-3 py-2 rounded-lg ${
                          ...
                          <span className={`font-medium ${
                            ...
                            {serverStatus === "running" ? "Server Running" :
                             ...
                             serverStatus === "starting" ? "Starting..." : "Unknown"}
                          </span>
                        </div>
                        {/* Uptime */}
                        {serverStatus === "running" && (
                  ...
                  <div className="mt-4 p-4 bg-muted rounded-xl">
                    ...
                    <div className="flex items-center gap-2">
                      <a
                        ...
                        className="flex-1 font-mono text-sm hover:underline" style={{ color: "#FF8400" }}
                      >
                        {deploymentUrl}
                      </a>
                      <button
              ...
              {/* Live Server Logs - Only show when deployed and running */}
