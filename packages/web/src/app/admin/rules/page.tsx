...
import { PlusIcon, RefreshCwIcon, EditIcon, TrashIcon } from "lucide-react";
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={() => (window.location.href = "/admin/rules/new")}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <select
              ...
              value={filter.entity || ""}
              onChange={(e) =>
                setFilter({ ...filter, entity: e.target.value || undefined })
              }
            >
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    onClick={() =>
                      (window.location.href = `/admin/rules/${rule.entityName}/${rule.id}`)
                    }
                  >
