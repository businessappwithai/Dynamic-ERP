...
import { ArrowLeftIcon, SaveIcon, CheckIcon, XIcon } from "lucide-react";
import { toast } from "sonner";
import { JDMEditor, JDMContent } from "@/components/rules/JDMEditor";
...
export default function RuleEditorPage() {
  ...
  useEffect(() => {
    fetchRule();
  }, [params.entity, params.ruleId]);

  const fetchRule = async () => {
    try {
      const response = await fetch(`/api/rules/${params.ruleId}`);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await fetchRule(); // Refresh to get new version
    } catch (error) {
  ...
  return (
    <div className="container mx-auto py-8 max-w-6xl">
      ...
      <Tabs value={activeTab} onValueChange={(v: string) => setActiveTab(v as "edit" | "validate" | "history")}>
        <TabsList>
        ...
        <TabsContent value="validate">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Check your rule syntax before saving
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="mb-4">
        ...
        <TabsContent value="history">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track changes to this rule over time
              </CardDescription>
            </CardHeader>
            <CardContent>
