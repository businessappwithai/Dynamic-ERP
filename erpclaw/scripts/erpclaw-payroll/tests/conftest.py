"""Shared pytest fixtures for ERPClaw Payroll unit tests."""
import os
import sys
...
import pytest
from payroll_helpers import init_all_tables, get_conn, build_payroll_env
...
@pytest.fixture
def env(conn):
    """Full payroll environment: company, FY, CC, accounts, employee, naming series."""
    return build_payroll_env(conn)
