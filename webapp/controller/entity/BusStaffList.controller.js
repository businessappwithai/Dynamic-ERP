/**
 * BusStaff List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Staff entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusStaffList", {
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "first_name", display_name: "First Name", data_type: "string", seq_no_grid: 10 },
        { column_name: "middle_name", display_name: "Middle Name", data_type: "string", seq_no_grid: 20 },
        { column_name: "last_name", display_name: "Last Name", data_type: "string", seq_no_grid: 30 },
        { column_name: "email", display_name: "Email", data_type: "string", seq_no_grid: 40 },
        { column_name: "phone", display_name: "Phone", data_type: "string", seq_no_grid: 50 },
        { column_name: "mobile", display_name: "Mobile", data_type: "string", seq_no_grid: 60 },
        { column_name: "role", display_name: "Role", data_type: "string", seq_no_grid: 90 },
        { column_name: "specialization", display_name: "Specialization", data_type: "string", seq_no_grid: 100 },
        { column_name: "qualification", display_name: "Qualification", data_type: "string", seq_no_grid: 110 },
        { column_name: "license_number", display_name: "License Number", data_type: "string", seq_no_grid: 120 },
        { column_name: "is_available", display_name: "Is Available", data_type: "boolean", seq_no_grid: 130 },
        { column_name: "hire_date", display_name: "Hire Date", data_type: "date", seq_no_grid: 140 },
        { column_name: "is_active", display_name: "Is Active", data_type: "boolean", seq_no_grid: 150 },
      ];
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_staff_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busStaffDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busStaffCreateRoute"); };
    },
