/**
 * BusBill Detail Controller - Object Page (Column 3)
 *
 * Dedicated detail controller for Bus Bill entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusBillDetail", {
    ...
    _loadFieldMetadata: function() {
      return new Promise(function(resolve, reject) {
        var oModel = this.getOwnerComponent().getModel();
        var aFilters = [
          new Filter("table_name", FilterOperator.EQ, "bus_bill"),
    ...
    _getDefaultFields: function() {
      return [
        ...
        {
          column_name: "insurance_claim_id",
          display_name: "Insurance Claim Id",
          data_type: "string",
          is_displayed: true,
          is_read_only: false,
          is_mandatory: true,
    ...
    onSavePress: function() {
      ...
      oModel.submitBatch("updateGroup").then(function() {
        ...
        MessageToast.show("Bus Bill saved successfully");
    ...
    onDeletePress: function() {
      var that = this;
      MessageBox.confirm("Are you sure you want to delete this Bus Bill?", {
    ...
    _deleteRecord: function() {
      ...
      if (oContext) {
        oContext.delete().then(function() {
          MessageToast.show("Bus Bill deleted successfully");
          this.onNavBack();
