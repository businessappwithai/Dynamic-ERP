/**
 * BusInsuranceProvider List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Insurance Provider entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusInsuranceProviderList", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busInsuranceProviderListRoute")
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "name", display_name: "Name", data_type: "string", seq_no_grid: 10 },
        { column_name: "code", display_name: "Code", data_type: "string", seq_no_grid: 20 },
        { column_name: "contact_person", display_name: "Contact Person", data_type: "string", seq_no_grid: 30 },
        { column_name: "phone", display_name: "Phone", data_type: "string", seq_no_grid: 40 },
        { column_name: "email", display_name: "Email", data_type: "string", seq_no_grid: 50 },
        { column_name: "address_line1", display_name: "Address Line1", data_type: "string", seq_no_grid: 60 },
        { column_name: "city", display_name: "City", data_type: "string", seq_no_grid: 70 },
        { column_name: "state", display_name: "State", data_type: "string", seq_no_grid: 80 },
        { column_name: "country", display_name: "Country", data_type: "string", seq_no_grid: 90 },
        { column_name: "is_active", display_name: "Is Active", data_type: "boolean", seq_no_grid: 100 },
      ];
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_insurance_provider_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busInsuranceProviderDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busInsuranceProviderCreateRoute"); };
    },
