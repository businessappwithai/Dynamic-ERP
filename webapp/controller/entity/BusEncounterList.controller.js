/**
 * BusEncounter List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Encounter entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusEncounterList", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busEncounterListRoute")
    ...
    _getFieldsFromMetadata: function() {
      ...
      aFields.push({
        column_name: "vitals_recorded",
        display_name: "Vitals Recorded",
        data_type: "boolean",
        seq_no_grid: 90,
        is_displayed_grid: true,
        is_selection_column: false
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "encounter_type", display_name: "Encounter Type", data_type: "string", seq_no_grid: 20 },
        { column_name: "status", display_name: "Status", data_type: "string", seq_no_grid: 30 },
        { column_name: "encounter_date", display_name: "Encounter Date", data_type: "date", seq_no_grid: 40 },
        { column_name: "discharge_date", display_name: "Discharge Date", data_type: "date", seq_no_grid: 50 },
        { column_name: "chief_complaint", display_name: "Chief Complaint", data_type: "string", seq_no_grid: 80 },
        { column_name: "vitals_recorded", display_name: "Vitals Recorded", data_type: "boolean", seq_no_grid: 90 },
        { column_name: "notes", display_name: "Notes", data_type: "text", seq_no_grid: 100 },
      ];
    ...
    onItemPress: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_encounter_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busEncounterDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busEncounterCreateRoute"); };
    },
