/**
 * BusEncounter Detail Controller - Object Page (Column 3)
 *
 * Dedicated detail controller for Bus Encounter entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusEncounterDetail", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busEncounterDetailRoute")
    ...
    _loadFieldMetadata: function() {
      return new Promise(function(resolve, reject) {
        var oModel = this.getOwnerComponent().getModel();
        var aFilters = [
          new Filter("table_name", FilterOperator.EQ, "bus_encounter"),
    ...
    onSavePress: function() {
      ...
      oModel.submitBatch("updateGroup").then(function() {
        ...
        MessageToast.show("Bus Encounter saved successfully");
    ...
    onDeletePress: function() {
      var that = this;
      MessageBox.confirm("Are you sure you want to delete this Bus Encounter?", {
    ...
    _deleteRecord: function() {
      ...
      if (oContext) {
        oContext.delete().then(function() {
          MessageToast.show("Bus Encounter deleted successfully");
          this.onNavBack();
