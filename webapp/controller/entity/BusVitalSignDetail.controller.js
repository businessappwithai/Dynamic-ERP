/**
 * BusVitalSign Detail Controller - Object Page (Column 3)
 *
 * Dedicated detail controller for Bus Vital Sign entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusVitalSignDetail", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busVitalSignDetailRoute")
    ...
    _loadFieldMetadata: function() {
      return new Promise(function(resolve, reject) {
        var oModel = this.getOwnerComponent().getModel();
        var aFilters = [
          new Filter("table_name", FilterOperator.EQ, "bus_vital_sign"),
    ...
    onSavePress: function() {
      ...
      oModel.submitBatch("updateGroup").then(function() {
        ...
        MessageToast.show("Bus Vital Sign saved successfully");
    ...
    onDeletePress: function() {
      var that = this;
      MessageBox.confirm("Are you sure you want to delete this Bus Vital Sign?", {
    ...
    _deleteRecord: function() {
      ...
      if (oContext) {
        oContext.delete().then(function() {
          MessageToast.show("Bus Vital Sign deleted successfully");
          this.onNavBack();
