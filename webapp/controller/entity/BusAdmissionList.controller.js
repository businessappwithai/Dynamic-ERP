/**
 * BusAdmission List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Admission entity.
 ...
 *
 * Generated: 2026-03-09T11:47:10.450Z
 */
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusAdmissionList", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busAdmissionListRoute")
    ...
    _getFieldsFromMetadata: function() {
      ...
      aFields.push({
        column_name: "secondary_diagnosis",
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "admission_date", display_name: "Admission Date", data_type: "date", seq_no_grid: 30 },
        { column_name: "discharge_date", display_name: "Discharge Date", data_type: "date", seq_no_grid: 40 },
        { column_name: "admission_type", display_name: "Admission Type", data_type: "string", seq_no_grid: 50 },
        { column_name: "status", display_name: "Status", data_type: "string", seq_no_grid: 60 },
        { column_name: "primary_diagnosis", display_name: "Primary Diagnosis", data_type: "string", seq_no_grid: 120 },
        { column_name: "secondary_diagnosis", display_name: "Secondary Diagnosis", data_type: "string", seq_no_grid: 130 },
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_admission_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busAdmissionDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busAdmissionCreateRoute"); };
    },
