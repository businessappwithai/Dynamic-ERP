/**
 * BusDiagnosis List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Diagnosis entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusDiagnosisList", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busDiagnosisListRoute")
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "diagnosis_date", display_name: "Diagnosis Date", data_type: "date", seq_no_grid: 30 },
        { column_name: "diagnosis_code", display_name: "Diagnosis Code", data_type: "string", seq_no_grid: 40 },
        { column_name: "diagnosis_type", display_name: "Diagnosis Type", data_type: "string", seq_no_grid: 50 },
        { column_name: "status", display_name: "Status", data_type: "string", seq_no_grid: 60 },
        { column_name: "notes", display_name: "Notes", data_type: "text", seq_no_grid: 70 },
      ];
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_diagnosis_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busDiagnosisDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busDiagnosisCreateRoute"); };
    },
