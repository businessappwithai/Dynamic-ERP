/**
 * BusPrescription List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Prescription entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusPrescriptionList", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busPrescriptionListRoute")
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "prescribed_date", display_name: "Prescribed Date", data_type: "date", seq_no_grid: 40 },
        { column_name: "prescribed_by", display_name: "Prescribed By", data_type: "string", seq_no_grid: 50 },
        { column_name: "dosage", display_name: "Dosage", data_type: "string", seq_no_grid: 60 },
        { column_name: "frequency", display_name: "Frequency", data_type: "string", seq_no_grid: 70 },
        { column_name: "route", display_name: "Route", data_type: "string", seq_no_grid: 80 },
        { column_name: "duration_days", display_name: "Duration Days", data_type: "integer", seq_no_grid: 90 },
        { column_name: "status", display_name: "Status", data_type: "string", seq_no_grid: 100 },
        { column_name: "notes", display_name: "Notes", data_type: "text", seq_no_grid: 110 },
      ];
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_prescription_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busPrescriptionDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busPrescriptionCreateRoute"); };
    },
