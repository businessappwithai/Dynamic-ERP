/**
 * BusDepartment List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Department entity.
 ...
 *
 * Generated: 2026-03-09T11:47:10.453Z
 */
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusDepartmentList", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busDepartmentListRoute")
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        ...
        { column_name: "description", display_name: "Description", data_type: "text", seq_no_grid: 20 },
        { column_name: "department_type", display_name: "Department Type", data_type: "string", seq_no_grid: 30 },
        { column_name: "is_active", display_name: "Is Active", data_type: "boolean", seq_no_grid: 60 },
      ];
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_department_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busDepartmentDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busDepartmentCreateRoute"); };
    },
