/**
 * BusVitalSign List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Vital Sign entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusVitalSignList", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busVitalSignListRoute")
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "recorded_date", display_name: "Recorded Date", data_type: "date", seq_no_grid: 30 },
        { column_name: "recorded_by", display_name: "Recorded By", data_type: "string", seq_no_grid: 40 },
        { column_name: "temperature", display_name: "Temperature", data_type: "decimal", seq_no_grid: 50 },
        { column_name: "pulse", display_name: "Pulse", data_type: "integer", seq_no_grid: 60 },
        { column_name: "respiration", display_name: "Respiration", data_type: "integer", seq_no_grid: 70 },
        { column_name: "systolic_bp", display_name: "Systolic Bp", data_type: "integer", seq_no_grid: 80 },
        { column_name: "diastolic_bp", display_name: "Diastolic Bp", data_type: "integer", seq_no_grid: 90 },
        { column_name: "oxygen_saturation", display_name: "Oxygen Saturation", data_type: "integer", seq_no_grid: 100 },
        { column_name: "weight", display_name: "Weight", data_type: "decimal", seq_no_grid: 110 },
        { column_name: "height", display_name: "Height", data_type: "decimal", seq_no_grid: 120 },
        { column_name: "blood_glucose", display_name: "Blood Glucose", data_type: "decimal", seq_no_grid: 130 },
        { column_name: "notes", display_name: "Notes", data_type: "text", seq_no_grid: 140 },
      ];
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_vital_sign_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busVitalSignDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busVitalSignCreateRoute"); };
    },
