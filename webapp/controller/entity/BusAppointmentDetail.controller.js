/**
 * BusAppointment Detail Controller - Object Page (Column 3)
 *
 * Dedicated detail controller for Bus Appointment entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusAppointmentDetail", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busAppointmentDetailRoute")
    ...
    _loadFieldMetadata: function() {
      return new Promise(function(resolve, reject) {
        var oModel = this.getOwnerComponent().getModel();
        var aFilters = [
          new Filter("table_name", FilterOperator.EQ, "bus_appointment"),
    ...
    onSavePress: function() {
      ...
      oModel.submitBatch("updateGroup").then(function() {
        ...
        MessageToast.show("Bus Appointment saved successfully");
    ...
    onDeletePress: function() {
      var that = this;
      MessageBox.confirm("Are you sure you want to delete this Bus Appointment?", {
    ...
    _deleteRecord: function() {
      ...
      if (oContext) {
        oContext.delete().then(function() {
          MessageToast.show("Bus Appointment deleted successfully");
          this.onNavBack();
