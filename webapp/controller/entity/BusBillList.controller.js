/**
 * BusBill List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Bill entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusBillList", {
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "bill_date", display_name: "Bill Date", data_type: "date", seq_no_grid: 20 },
        { column_name: "due_date", display_name: "Due Date", data_type: "date", seq_no_grid: 30 },
        { column_name: "total_amount", display_name: "Total Amount", data_type: "decimal", seq_no_grid: 40 },
        { column_name: "paid_amount", display_name: "Paid Amount", data_type: "decimal", seq_no_grid: 50 },
        { column_name: "status", display_name: "Status", data_type: "string", seq_no_grid: 60 },
        { column_name: "payment_method", display_name: "Payment Method", data_type: "string", seq_no_grid: 70 },
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_bill_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busBillDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busBillCreateRoute"); };
    },
