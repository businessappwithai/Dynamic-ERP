/**
 * BusDepartment Detail Controller - Object Page (Column 3)
 *
 * Dedicated detail controller for Bus Department entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusDepartmentDetail", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busDepartmentDetailRoute")
    ...
    _loadFieldMetadata: function() {
      return new Promise(function(resolve, reject) {
        var oModel = this.getOwnerComponent().getModel();
        var aFilters = [
          new Filter("table_name", FilterOperator.EQ, "bus_department"),
    ...
    _getDefaultFields: function() {
      return [
        ...
        },
        {
          ...
          display_name: "Parent Department Id",
          data_type: "string",
          is_displayed: true,
          is_read_only: false,
          is_mandatory: true,
    ...
    onSavePress: function() {
      ...
      oModel.submitBatch("updateGroup").then(function() {
        ...
        MessageToast.show("Bus Department saved successfully");
    ...
    onDeletePress: function() {
      var that = this;
      MessageBox.confirm("Are you sure you want to delete this Bus Department?", {
    ...
    _deleteRecord: function() {
      ...
      if (oContext) {
        oContext.delete().then(function() {
          MessageToast.show("Bus Department deleted successfully");
          this.onNavBack();
