/**
 * BusLabResult Detail Controller - Object Page (Column 3)
 *
 * Dedicated detail controller for Bus Lab Result entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusLabResultDetail", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busLabResultDetailRoute")
    ...
    _loadFieldMetadata: function() {
      return new Promise(function(resolve, reject) {
        var oModel = this.getOwnerComponent().getModel();
        var aFilters = [
          new Filter("table_name", FilterOperator.EQ, "bus_lab_result"),
    ...
    onSavePress: function() {
      ...
      oModel.submitBatch("updateGroup").then(function() {
        ...
        MessageToast.show("Bus Lab Result saved successfully");
    ...
    onDeletePress: function() {
      var that = this;
      MessageBox.confirm("Are you sure you want to delete this Bus Lab Result?", {
    ...
    _deleteRecord: function() {
      ...
      if (oContext) {
        oContext.delete().then(function() {
          MessageToast.show("Bus Lab Result deleted successfully");
          this.onNavBack();
