/**
 * BusLabOrder Detail Controller - Object Page (Column 3)
 *
 * Dedicated detail controller for Bus Lab Order entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusLabOrderDetail", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busLabOrderDetailRoute")
    ...
    _loadFieldMetadata: function() {
      return new Promise(function(resolve, reject) {
        var oModel = this.getOwnerComponent().getModel();
        var aFilters = [
          new Filter("table_name", FilterOperator.EQ, "bus_lab_order"),
    ...
    onSavePress: function() {
      ...
      oModel.submitBatch("updateGroup").then(function() {
        ...
        MessageToast.show("Bus Lab Order saved successfully");
    ...
    onDeletePress: function() {
      var that = this;
      MessageBox.confirm("Are you sure you want to delete this Bus Lab Order?", {
    ...
    _deleteRecord: function() {
      ...
      if (oContext) {
        oContext.delete().then(function() {
          MessageToast.show("Bus Lab Order deleted successfully");
          this.onNavBack();
