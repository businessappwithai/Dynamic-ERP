/**
 * BusAppointment List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Appointment entity.
 ...
 *
 * Generated: 2026-03-09T11:47:10.448Z
 */
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusAppointmentList", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busAppointmentListRoute")
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "appointment_date", display_name: "Appointment Date", data_type: "date", seq_no_grid: 40 },
        { column_name: "appointment_time", display_name: "Appointment Time", data_type: "datetime", seq_no_grid: 50 },
        { column_name: "duration", display_name: "Duration", data_type: "integer", seq_no_grid: 60 },
        { column_name: "appointment_type", display_name: "Appointment Type", data_type: "string", seq_no_grid: 70 },
        { column_name: "status", display_name: "Status", data_type: "string", seq_no_grid: 80 },
        { column_name: "reason", display_name: "Reason", data_type: "string", seq_no_grid: 90 },
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_appointment_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busAppointmentDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busAppointmentCreateRoute"); };
    },
