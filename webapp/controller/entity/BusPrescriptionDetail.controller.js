/**
 * BusPrescription Detail Controller - Object Page (Column 3)
 *
 * Dedicated detail controller for Bus Prescription entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusPrescriptionDetail", {
    ...
    onInit: function() {
      ...
      this._getRouter()
        .getRoute("busPrescriptionDetailRoute")
    ...
    _loadFieldMetadata: function() {
      return new Promise(function(resolve, reject) {
        var oModel = this.getOwnerComponent().getModel();
        var aFilters = [
          new Filter("table_name", FilterOperator.EQ, "bus_prescription"),
    ...
    onSavePress: function() {
      ...
      oModel.submitBatch("updateGroup").then(function() {
        ...
        MessageToast.show("Bus Prescription saved successfully");
    ...
    onDeletePress: function() {
      var that = this;
      MessageBox.confirm("Are you sure you want to delete this Bus Prescription?", {
    ...
    _deleteRecord: function() {
      ...
      if (oContext) {
        oContext.delete().then(function() {
          MessageToast.show("Bus Prescription deleted successfully");
          this.onNavBack();
