/**
 * BusLabOrder List Controller - Entity Table (Column 2)
 *
 * Dedicated list controller for Bus Lab Order entity.
...
sap.ui.define([
  ...
  return Controller.extend("hospital-management-system.controller.entity.BusLabOrderList", {
    ...
    _getFieldsFromMetadata: function() {
      var aFields = [];
      aFields.push({
        column_name: "ordered_date",
        display_name: "Ordered Date",
        data_type: "date",
        seq_no_grid: 30,
      ...
      aFields.push({
        column_name: "clinical_indication",
        display_name: "Clinical Indication",
        data_type: "string",
        seq_no_grid: 80,
        is_displayed_grid: true,
        is_selection_column: false
    ...
    _buildDefaultColumns: function() {
      var aDefaults = [
        { column_name: "ordered_date", display_name: "Ordered Date", data_type: "date", seq_no_grid: 30 },
        { column_name: "ordered_by", display_name: "Ordered By", data_type: "string", seq_no_grid: 40 },
        { column_name: "test_type", display_name: "Test Type", data_type: "string", seq_no_grid: 50 },
        { column_name: "priority", display_name: "Priority", data_type: "string", seq_no_grid: 60 },
        { column_name: "status", display_name: "Status", data_type: "string", seq_no_grid: 70 },
        { column_name: "clinical_indication", display_name: "Clinical Indication", data_type: "string", seq_no_grid: 80 },
        { column_name: "notes", display_name: "Notes", data_type: "text", seq_no_grid: 90 },
      ];
    ...
    onDataReceived: function(oEvent) {
      ...
      var sId = oContext.getProperty("id") || oContext.getProperty("bus_lab_order_id");
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busLabOrderDetailRoute", { id: sId }); };
    },
    ...
    onCreatePress: function() {
      var oRouter = this._getRouter(); if (oRouter) { oRouter.navTo("busLabOrderCreateRoute"); };
    },
